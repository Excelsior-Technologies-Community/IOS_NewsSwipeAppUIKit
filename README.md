...
**Solution:** Make sure images are added to Assets.xcassets with correct names

### Issue: Cards not snapping
**Solution:** Verify `isPagingEnabled = true` and cell size matches screen

### Issue: Content not scrolling
**Solution:** Check UIScrollView constraints in NewsCollectionViewCell
